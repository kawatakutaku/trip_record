                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    @foreach($memoResponses as $memoResponse)
                        ...
                        <div class="row p-2 justify-content-center">
                            ...
                            <x-linkbutton href="{{ route('responses.show', [App\Models\MemoResponse::MEMO_RESPONSE_ID => $memoResponse->id]) }}">
                                <i class="fas fa-lg fa-file-alt"></i>
                            </x-linkbutton>
                            <form action="{{ route('responses.destroy', [App\Models\MemoResponse::MEMO_RESPONSE_ID => $memoResponse->id]) }}" method="post">
                                <x-delete />
                            </form>
                        </div>
                    @endforeach
